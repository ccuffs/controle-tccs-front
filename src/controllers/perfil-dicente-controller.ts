 ...
 */
export function validarEmailAlterado(
 ...
 */
export function validarFormatoEmail(email: string | undefined): boolean {
 ...
 */
export function processarDadosDicente(
	dicente: Partial<Dicente> | null | undefined,
): DicenteExibicao | null {
 ...
 */
export function obterMensagemSucesso(): string {
 ...
 */
export function isDicenteCarregado(dicente: unknown): boolean {
	return !!dicente;
}
