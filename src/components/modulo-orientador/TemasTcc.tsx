...
interface TemasTccProps {
	isOrientadorView?: boolean;
}

export default function TemasTcc({ isOrientadorView = false }: TemasTccProps) {
	const {
		// Estados de dados
		temas,
		cursos,
		...
		<Box sx={{ width: 1400 }}>
			<Stack spacing={2} sx={{ width: "100%" }}>
				...
				<Dialog
					...
					fullWidth
				>
					<DialogTitle id="criar-area-title">Criar Nova Área TCC</DialogTitle>
					<DialogContent>
					...
					<DialogActions>
						...
						<Button onClick={handleCreateArea} variant="contained" color="primary">
							Criar Área
						</Button>
					</DialogActions>
				</Dialog>
				...
				>
					...
					<DialogContent>
						<Stack spacing={2} sx={{ mt: 1 }}>
							...
							<Typography variant="caption" color="text.secondary">
								Nota: As vagas são por oferta do docente, não por tema
								individual. Alterar aqui afetará todos
								{isOrientadorView
					...
					<DialogActions>
						<Button onClick={handleCloseVagasModal}>Cancelar</Button>
						<Button onClick={handleUpdateVagas} variant="contained" color="primary">
							Atualizar Vagas
						</Button>
					</DialogActions>
				</Dialog>
