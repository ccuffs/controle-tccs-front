...
import { useModuloOrientador } from "../hooks/useModuloOrientador";
	...
	return (
		<Box sx={{ width: 1400 }}>
			...
			<Box sx={{ borderBottom: 1, borderColor: "divider" }}>
				<Tabs value={tabValue} onChange={handleTabChange} aria-label="orientador tabs">
					<Tab
						label="Dashboard"
						disabled={isBanca}
			...
			<AccessibleTabPanel idPrefix="orientador" value={tabValue} index={8}>
				<PerfilOrientador />
			</AccessibleTabPanel>
		</Box>
	);
