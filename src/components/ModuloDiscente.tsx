...
import { useModuloDiscente } from "../hooks/useModuloDiscente";
import { AccessibleTabPanel, getA11yProps } from "./customs/AccessibleTabs";
...
export default function ModuloDiscente() {
	...
	const renderizarConteudo = () => {
		...
		return <TccStepper etapaInicial={etapaAtual} onEtapaChange={setEtapaAtual} />;
	};
	...
	return (
		<Box sx={{ width: 1400 }}>
			...
			<Box sx={{ borderBottom: 1, borderColor: "divider" }}>
				<Tabs value={tabValue} onChange={handleTabChange} aria-label="discente tabs">
