...
import type { ConvitePeriodoPonto } from "../../types/dashboard";

interface GraficoConvitesPeriodoProps {
	dadosConvites: ConvitePeriodoPonto[];
	faseLabel?: string;
	ticksConvites?: string[];
