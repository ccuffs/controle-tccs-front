...
import { useDicenteModal } from "../hooks/useDicenteModal";
import type { DicenteFormData } from "../controllers/dicentes-controller";

interface DicenteModalProps {
	open: boolean;
	onClose: () => void;
	isEditing: boolean;
			...
			<DialogContent>
				<Stack spacing={2} sx={{ mt: 1 }}>
					<TextField
						...
						required
						disabled={isEditing}
						helperText={isEditing ? "A matrícula não pode ser alterada" : ""}
					/>
					<TextField
						name="nome"
						label="Nome"
